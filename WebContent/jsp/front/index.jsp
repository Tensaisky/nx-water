		...
		<div id="header" class="header navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
							<li><a href="javascript:;" onclick="ajaxloa('../user/userManagement.jsp')" style="color: #000000">个人中心</a></li>
			...
			<div  id="navbar" data-scrollbar="true" data-height="100%" style="background-color: #87AF4C;">
				...
				<ul id="liang" class="nav">
					...
					<li class="has-sub ">
						...
						<ul class="sub-menu">
							<li><a href="javascript:;" onclick="ajaxloa('../admin/DateEcharts.jsp')" >统计图</a></li>
							<li><a href="javascript:;" onclick="ajaxloa('../admin/DataReport.jsp')">报表</a></li>		
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="javascript:;" onclick="ajaxloa('../user/userManagement.jsp')">用户管理</a></li>
